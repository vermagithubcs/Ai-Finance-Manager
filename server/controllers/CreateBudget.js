...
const createBudget = async (req, res) => {
  const { userId, currentAmount, category, limit, startDate, endDate } =
    req.body;
  try {
...
const deleteBudget = async (req, res) => {
  ...
  try {
    ...
    // Assuming user model has a reference to the budget
    // You can update this part based on your actual user model structure
    await User.updateOne({ _id: userId }, { $pull: { budgets: id } });
